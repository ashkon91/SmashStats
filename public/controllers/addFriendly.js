...
.controller('AddFriendlyCtrl', function($rootScope, $scope, $http, SmashServices) {
  ...
  function checkFieldsSelected(){
    if($scope.obj.character_selected['name'] == "Choose a character" || $scope.obj2.character_selected['name'] == "Choose a character" ||  $scope.stageobj.stage_selected['name'] == "Choose a stage")
        return false;
    return true;
}
